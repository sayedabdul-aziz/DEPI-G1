...
import 'package:se7ety/features/patient/home/data/specialization_card_model.dart';
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: model.colorPair.primaryColor,
        borderRadius: BorderRadius.circular(25),
        boxShadow: [
          BoxShadow(
            offset: const Offset(4, 4),
            blurRadius: 10,
            color: model.colorPair.lightColor.withValues(alpha: .8),
          ),
        ],
      ),
      child: ClipRRect(
        ...
        child: Stack(
          ...
          children: [
            Positioned(
              ...
              right: -20,
              child: CircleAvatar(
                backgroundColor: model.colorPair.lightColor.withValues(
                  alpha: .3,
                ),
                radius: 60,
              ),
